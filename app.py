...
import pickle #pickle (to load the pre-trained model)
import numpy as np  # NumPy (for numerical operations) 

#Sets the title of the app displayed in the browser tab.
st.set_page_config(page_title="The Mavericks | Customer Churn Prediction App") 

# Loads the pre-trained model stored in model.sav using pickle.
